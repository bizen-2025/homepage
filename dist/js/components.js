...
function loadSidebar(currentPage) {
  const sidebarHTML = `
    ...
    <nav class="sidebar-nav">
      ...
      <a href="/admin/leads.html" class="nav-item ${currentPage === 'leads' ? 'active' : ''}">
        <span class="nav-icon">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <a href="/admin/board.html" class="nav-item ${currentPage === 'board' ? 'active' : ''}">
        <span class="nav-icon">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <a href="/admin/analytics.html" class="nav-item ${currentPage === 'analytics' ? 'active' : ''}">
        <span class="nav-icon">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
